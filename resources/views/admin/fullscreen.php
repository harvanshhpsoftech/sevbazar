...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/maps/fullscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Oct 2018 07:29:13 GMT -->
    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-minimize">
          <button id="minimizeSidebar" class="btn btn-just-icon btn-white btn-fab btn-round">
			...
			<a class="navbar-brand" href="#pablo">Full Screen Map</a>
		</div>
