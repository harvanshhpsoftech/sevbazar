                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                        <img src="{{ asset('images/backend_img/flags/US.png')}}"/> </div>
                                                                </td>
                                                                <td>USA</td>
                                                                <td class="text-right">
                                                                    2.920
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('images/backend_img/flags/DE.png')}}" </div>
                                                                </td>
                                                                <td>Germany</td>
                                                                <td class="text-right">
                                                                    1.300
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('images/backend_img/flags/AU.png')}}" </div>
                                                                </td>
                                                                <td>Australia</td>
                                                                <td class="text-right">
                                                                    760
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('images/backend_img/flags/GB.png')}}" </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('images/backend_img/flags/RO.png')}}" </div>
                                                                </td>
                                                                <td>Romania</td>
                                                                <td class="text-right">
                                                                    600
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('images/backend_img/flags/BR.png')}}" </div>
                                                                </td>
                                                                <td>Brasil</td>
                                                                <td class="text-right">
                                                                    550
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="card card-product">
                                                            <div class="card-header card-header-image" data-header-animation="true">
                                                                <a href="#pablo">
                                                                    <img class="img" src="{{ asset('images/backend_img/card-2.jpg')}}">
                                                                </a>
                                                            </div>
                                                            <div class="card-body">
                          ...
                          <a href="#pablo">Cozy 5 Stars Apartment</a>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="card card-product">
                                                            <div class="card-header card-header-image" data-header-animation="true">
                                                                <a href="#pablo">
                                                                    <img class="img" src="{{ asset('images/backend_img/card-3.jpg')}}">
                                                                </a>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="card-actions text-center">
                          ...
                          <a href="#pablo">Office Studio</a>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="card card-product">
                                                            <div class="card-header card-header-image" data-header-animation="true">
                                                                <a href="#pablo">
                                                                    <img class="img" src="{{ asset('images/backend_img/card-1.jpg')}}">
                                                                </a>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="card-actions text-center">
