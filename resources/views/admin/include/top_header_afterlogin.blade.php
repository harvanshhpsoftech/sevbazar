...
<head>
    ...
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('images/backend_img/apple-icon.png')}}">
    <link rel="icon" type="image/png" href="{{asset('images/backend_img/favicon.png')}}">
