...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Oct 2018 07:29:08 GMT -->
<!-- Added by HTTrack -->
...
<body class="off-canvas-sidebar">
    ...
    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white" id="navigation-example">
        <div class="container">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="">Sev Bazar</a>
            </div>
    ...
    <div class="wrapper wrapper-full-page">
        ...
        <div class="page-header login-page header-filter" filter-color="black" style="background-image: url({{ asset('images/backend_img/login.jpg') }}); background-size: cover; background-position: top center;">
            <!--   you can change the color of the filter page using: data-color="blue | purple | green | orange | red | rose " -->
            <div class="container">
                <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
                    <form class="form" method="" action="{{url('Dashboard')}}">
                        @csrf
    ...
    <div class="card-footer justify-content-center">
        <input type="submit" name="" class="btn btn-rose btn-link btn-lg" value="Lets Go">
        ...
        <div class="container">
            ...
            <div class="copyright float-right">
                ...
                <a href="http://hpsoftech.com/" target="_blank">HP Software Technology</a> .
            </div>
        </div>
    </footer>
